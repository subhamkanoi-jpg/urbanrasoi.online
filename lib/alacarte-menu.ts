...
export const menuSections: MenuSection[] = [
  {
    ...
    items: [
      { id: 'quesadillas', name: 'Bite Size Quesadillas', unit: '4 pcs', price: 330 },
      { id: 'pita-pockets', name: 'Pita Pockets', unit: '4 pcs', price: 330 },
      { id: 'pizza-slices', name: 'Farmhouse Pizza Slices', unit: '4 pcs', price: 280 },
      { id: 'mushroom-dumplings', name: 'Cream of Mushroom Dumplings', unit: '4 pcs', price: 370 },
      { id: 'crystal-dumplings', name: 'Crystal Vegetable Dumplings', unit: '4 pcs', price: 300 },
      { id: 'avocado-sushi', name: 'Avocado Cream & Cheese Sushi', unit: '4 pcs', price: 480 },
    ],
  },
  {
    ...
    group: 'Starters',
    items: [
      { id: 'cheese-corn-samosa', name: 'Cheese & Corn Samosa', unit: '6 pcs', price: 310 },
      { id: 'cocktail-samosa', name: 'Cocktail Samosa', unit: '8 pcs', price: 250 },
      { id: 'cheese-balls', name: 'Classic Cheese Balls', unit: '15 pcs', price: 380 },
      { id: 'veg-momo', name: 'Veg Steamed Momo', unit: '15 pcs', price: 370 },
      { id: 'nachos', name: 'Nachos with In-House Salsa & Cheese Sauce', unit: '1 portion', price: 380 },
    ],
  },
  {
    id: 'tandoori',
    ...
    items: [
      { id: 'hara-bhara', name: 'Hara Bhara Kebab Croquettes', unit: '6 pcs', price: 370 },
      { id: 'achari-paneer-tikka', name: 'Achari Paneer Tikka', unit: '6 pcs', price: 410 },
      { id: 'aloo-tikka', name: 'Tandoori Stuffed Aloo Tikka', unit: '6 pcs', price: 370 },
      { id: 'galouti', name: 'Mushroom Galouti Kebab', unit: '6 pcs', price: 440 },
      { id: 'tandoori-momo', name: 'Tandoori Momo', unit: '6 pcs', price: 410 },
      { id: 'dahi-kebab', name: 'Dahi Kebab Croquettes', unit: '6 pcs', price: 370 },
    ],
  },
  {
    id: 'chaats',
    ...
    group: 'Starters',
    items: [
      { id: 'raj-kachori', name: 'Raj Kachori Chaat', unit: '6 pcs', price: 370 },
      { id: 'palak-patta', name: 'Palak Patta Chaat', unit: '8 pcs', price: 370 },
      { id: 'paw-bhaji-chaat', name: 'Paw Bhaji', unit: '6 pcs', price: 410, alias: 'pav bhaji' },
      { id: 'chola-tikki', name: 'Chola Tikki Chaat', unit: '6 pcs', price: 410 },
    ],
  },
  {
    ...
    group: 'Starters',
    items: [
      { id: 'pindi-naanza', name: 'Pindi Chana Naanza', unit: '5 pcs', price: 400 },
      { id: 'paneer-naanza', name: 'Tandoori Paneer Naanza', unit: '5 pcs', price: 440 },
      { id: 'paw-bhaji-sliders', name: 'Paw Bhaji Sliders', unit: '6 pcs', price: 450, alias: 'pav bhaji sliders' },
      { id: 'dabeli', name: 'Dabeli', unit: '6 pcs', price: 450 },
      { id: 'cottage-cheese-wrap', name: 'Italian Cottage Cheese Wrap', unit: '4 pcs', price: 480 },
      { id: 'mediterranean-wrap', name: 'Mediterranean Wrap', unit: '4 pcs', price: 510 },
      { id: 'garlic-bread', name: 'Cheesy Garlic Bread', unit: '8 pcs', price: 440 },
    ],
  },
  {
    id: 'north-indian',
  ...
  },
  {
    ...
    group: 'Mains',
    items: [
      { id: 'kulcha', name: 'Kulcha', unit: '4 pcs', price: 230 },
      { id: 'masala-kulcha', name: 'Masala Kulcha', unit: '4 pcs', price: 280 },
      { id: 'paneer-kulcha', name: 'Paneer Vegetable Kulcha', unit: '4 pcs', price: 300 },
      { id: 'lachha-paratha', name: 'Pudina Lachha Paratha', unit: '4 pcs', price: 280 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'pooran-poli', name: 'Pooran Poli', unit: '6 pcs', price: 320 },
      { id: 'dal-badam-halwa', name: 'Dal-Badam Halwa', unit: '500 ml', price: 630 },
      { id: 'rajasthani-dahi-vada', name: 'Rajasthani Dahi Vada', unit: '5 pcs', price: 320 },
    ],
  },
  {
    id: 'continental',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'manchurian', name: 'Vegetable Manchurian Balls', unit: '6 pcs', price: 370 },
  ...
  },
  {
    ...
    group: 'Desserts',
    items: [
      { id: 'monte-carlo', name: 'Chocolate Monte Carlo', unit: '500 ml', price: 460 },
      { id: 'kesariya-rasmalai', name: 'Kesariya Rasmalai', unit: '6 pcs', price: 350 },
      { id: 'darsan', name: 'Darsan', unit: '500 ml', price: 370 },
      { id: 'gulabjamun', name: 'Gulabjamun', unit: '6 pcs', price: 210 },
      { id: 'seasonal-sandesh', name: 'Seasonal Sandesh', unit: '6 pcs', price: 280 },
      { id: 'fudge-brownie', name: 'Fudge Brownie', unit: '4 pcs', price: 410 },
    ],
  },
]
